...
//
pub contract OpenSpaceNFTStorefront {
  ...
  pub resource Listing: ListingPublic {
    ...
    pub fun borrowNFT(): & NonFungibleToken.NFT {
      ...
      //  result.isInstance(Type<@OpenSpaceItems.NFT>()): "token has wrong type"
      assert(ref.isInstance(Type<@OpenSpaceItems.NFT>()), message: "token has wrong type")
    ...
    pub fun purchase(payment: @FungibleToken.Vault): @NonFungibleToken.NFT {
      ...
      assert(nft.isInstance(Type<@OpenSpaceItems.NFT>()), message: "withdrawn NFT is not of specified type")
    ...
    init(
      ...
      assert(nft.isInstance(Type<@OpenSpaceItems.NFT>()), message: "token is not of specified type")
