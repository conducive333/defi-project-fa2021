export default (flowStorefrontAddress: string) =>
  ...
  pub fun main(account: Address, setID: String): &{String : AdminNFTStorefrontV3.Listing{AdminNFTStorefrontV3.ListingPublic}}? {
    ...
    return storefrontRef.borrowListings(setID: setID)
}
`
