...
if __name__ == "__main__":
  print()
  if len(sys.argv) <= 1: raise Exception('Expected at least one argument')
  if sys.argv[1] != 'image' and sys.argv[1] != 'video': raise Exception('Expected first argument to be either `image` or `video`')
